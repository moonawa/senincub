  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="#">Mon Equipe<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="#">Ajouter un membre à mon équipe</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">Mes Clients</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">Ajouter un Metier</a>
      </li>
