...
<input type="text" class="bg" name="email" placeholder="email employe">
<input type="text" class="bg" name="emails" placeholder="email entreprise">
   <button type="submit" class="btn btna">Allouer</button>
</form>
<br><br><br><br><br>
...
<input type="text" class="bg" name="email" placeholder="email employe">
<input type="text" class="bg" name="emails" placeholder="email entreprise">
   <button type="submit" class="btn btna">Enlever</button>
</form>
