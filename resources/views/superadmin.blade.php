  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="#">Inscrire un Employé</a>
          <a class="dropdown-item" href="#">Inscrire une Entreprise et son Utilisateur</a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="#">Allouer un employé à une entreprise<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#">Liste des Entreprises</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">Liste des Employés</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">Selectionner des Inscris</a>
      </li>
    </ul>
